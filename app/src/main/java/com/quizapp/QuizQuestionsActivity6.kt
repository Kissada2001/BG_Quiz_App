...
class QuizQuestionsActivity6: AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mmQuestionsList = Constants.getQuestions6()
                ...
                if (mmSelectedOptionPosition == 0) {
                    ...
                    when {
                        mmCurrentPosition <= mmQuestionsList!!.size -> {
                            ...
                            val intent =
                                Intent(this@QuizQuestionsActivity6, ResultActivity::class.java)
